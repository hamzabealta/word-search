...
const DefaultTitle = () => {
  ...
  return (
    <div
      ...
      className='page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2'
    >
      {/* begin::Heading */}
      {pageTitle && (
        <h1 className='d-flex flex-column text-dark fw-bolder my-0 fs-1 pb-5 pb-lg-0'>
          {pageTitle}
          {pageDescription && (
